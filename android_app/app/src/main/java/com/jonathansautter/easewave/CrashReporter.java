    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.easewavebugreport));
                emailIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.easewavejustcrashed) + logStr);
